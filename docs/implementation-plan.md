...
- [~] Projects/RPPS/BOMs: versioned RPPS schema/import/export, normalized persistence, publication, BOM versions/items/export/fork, repository-import boundary, review staging, and administrator-gated organization ownership/visibility settings are implemented. Generated BOM scope stays synchronized with its project. Rich maintainer/media/evidence/known-issue editing screens remain limited.
