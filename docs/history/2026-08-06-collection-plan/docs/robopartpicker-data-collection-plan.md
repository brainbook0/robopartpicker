...
approved: false
status: review-draft-runtime-revision-required
runtime_architecture_superseded_by: plans/2026-08-06-002-cloudflare-first-scraping-operations-plan.md
created: '2026-07-28'
...
> **Runtime architecture notice, 2026-08-06:** The Cloudflare-first scraping operations plan supersedes this document's external Python collector, GitHub Actions scheduler, laptop-runner, and dedicated external-runner assumptions. The provenance, policy, staging, review, canonical promotion, withdrawal, and audit requirements remain applicable. Implementation units U-006 and U-013 require revision before execution. See [`plans/2026-08-06-002-cloudflare-first-scraping-operations-plan.md`](plans/2026-08-06-002-cloudflare-first-scraping-operations-plan.md).
