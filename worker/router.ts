...
import { sourceEvidenceRoutes } from "./routes/source-evidence";
import { searchRoutes } from "./routes/search";
import { aiRoutes } from "./routes/ai";
import { aiSystemRoutes } from "./routes/ai-systems";
import { projectImportJobRoutes } from "./routes/project-import-jobs";
import { knowledgeWorkflowRoutes } from "./routes/knowledge-workflows";
import { messagingSafetyRoutes } from "./routes/messaging-safety";
import { marketplaceAnalyticsOperationsRoutes } from "./routes/marketplace-analytics-operations";
...
app.route("/api/v1", sourceEvidenceRoutes);
app.route("/api/v1", searchRoutes);
app.route("/api/v1", aiRoutes);
app.route("/api/v1", aiSystemRoutes);
app.route("/api/v1", projectImportJobRoutes);
app.route("/api/v1", knowledgeWorkflowRoutes);
app.route("/api/v1", messagingSafetyRoutes);
app.route("/api/v1", marketplaceAnalyticsOperationsRoutes);
